...
| The power-saving transport estimate (PT). | incomplete | `RESEARCH_CONTINUATION.md`, after Theorem 25 | PT is a sufficient conjecture, not a theorem. Exact class-weighted floating-point data through order 9 show positive \(\Delta_n/n^2\) with no observed decay on the tested grids; this is evidence only and does not disprove PT. |
